...
class MercadosPreciosPointers(object):
    ...
    HOUR_LIST_HIDDEN = (By.XPATH, "//*[@class='chzn-container chzn-container-single']")
    HOUR_LIST_ACTIVE = (By.XPATH, "//*[@class='chzn-container chzn-container-single chzn-container-active']")
    HOUR_LIST_ACTIVE_DROP = (By.XPATH,"//*[@class='chzn-container chzn-container-single chzn-with-drop chzn-container-active']")
...
class GeneracionConsumoPointers(object):
    ...
    HOUR_LIST_HIDDEN = (By.XPATH, "/html/body/div[3]/div[2]/div/div/div[3]/aside/div/div/div[3]/div/div/div[1]")
    HOUR_LIST_ACTIVE = (By.XPATH, "//*[@class='chzn-container chzn-container-single chzn-container-active']")
